...
After matching, **`r format(noMatch, big.mark = ",", scientific = FALSE)`** observations remained not classified and it was assigned **NA** to them. This represents **`r round(noMatch/902297)`%** of the total observations, **`r noMatchDMG`%** of the total damages (properties + crops), **`r noMatchFatalities`%** of the total fatalities, and **`r noMatchInjuries`%** of the total injuries. Since there aren't economic and health effects, they will not be used for further computation of impacts. 
...
Observing the *Total* graph, flood is the major cause of economic damages by far. More than twice the damage caused by tornados. The total economic damage caused by flood is **US$ `r format(y3[1], big.mark = ",", scientific = FALSE)`** billion dollars. Tornado accounts for **US$ `r format(y3[2], big.mark = ",", scientific = FALSE)`** billion dollars.
  
Damage to properties overcome damage to crops. Crop damages correspond to only **`r with(dados, sum(rural)/sum(economico))`%** of total economic damages. Properties indeed are more affected by flood and tornado. However, crops suffer more from hail and drought. Crops seem to be more damaged by events that have phisyological effects than events that have mechanical effects.
...
As the graphs present, tornado is the major cause of injuries and fatalities. Tornado accounts for **`r format(y3[1], big.mark = ",", scientific = FALSE)`** thousand inahitants with health incidents. More than seven times the incidents caused by heat.  Heat accounts for **`r format(y3[2], big.mark = ",", scientific = FALSE)`** thousand inahitants with health incidents.
